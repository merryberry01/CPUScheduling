...
SHELLCOMMANDENTRY gs_vstCommandTable[] =
{
        ...
        { "createsjftask", "Create SJF Task ex) createsjftask 3(count) 50(ms) 40(ms) 30(ms)", kCreateSJFTestTask },
};                                     
 ...
 * SJF create task
 */
static void kCreateSJFTestTask( const char* pcParameterBuffer )
{
    PARAMETERLIST stList;
    char vcCount[ 30 ];
    char vcTime[ 30 ];
